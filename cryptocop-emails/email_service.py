...
def send_simple_message(to, subject, body):
    return requests.post(
        "https://api.mailgun.net/v3/sandboxe6949fb9260e4ccba2adebf84be27c12.mailgun.org/messages",
        auth=("api", "546cdacc17ea0d03370e2bc86ec131ad-53c13666-5be9b609"),
        data={"from": "Mailgun Sandbox <postmaster@sandboxe6949fb9260e4ccba2adebf84be27c12.mailgun.org>",
              "to": to,
              "subject": subject,
              "html": body})
